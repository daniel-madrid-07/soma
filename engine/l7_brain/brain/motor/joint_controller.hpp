// SOMA — L7 — controlador motor de una articulación (PD sobre músculos antagonistas).
//
// CLAVE: el controlador NO emite par. Emite ACTIVACIÓN [0..1] para cada músculo.
// La fuerza (y por tanto el par) surge del modelo Hill. Así respetamos la filosofía:
// el cerebro ordena "cuánto contraer", no "cuánto par ejercer".
//
...
struct JointController {
    ...
    // Dado el ángulo y su velocidad (de la propiocepción), reparte activación.
