...
//
// Oscilador de Matsuoka de medio-centro: dos neuronas que se inhiben mutuamente y
// se adaptan (fatiga). Producen una salida RÍTMICA en antifase — el sustrato
// neuronal del ritmo locomotor en la médula. No hay reloj externo: el ritmo EMERGE
// de la dinámica neuronal. Una neurona excita al flexor, la otra al extensor.
//
...
// sensorial (permite que el reflejo module el ritmo). El ritmo cesa si s = 0.
#pragma once
